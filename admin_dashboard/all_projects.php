    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">Showing All Projects</h4>
              <div class="row">
                <div class="col-12">
                    ...
                    <table id="order-listing" class="table">
                      ...
                      <tbody>
                        <?php
                          $report_counter = 1;
                          $empty = TRUE;
                          $table_result = $db_handle->query("SELECT * FROM projects");
