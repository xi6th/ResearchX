    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
							...
							<div class="card bg-facebook">
								<div class="card-body">
									<div class="d-flex flex-row align-items-top">
										...
										<div class="ml-3">
                    <?php
                      $unseen_reports_query = "SELECT * FROM projects WHERE status='unseen' AND day='$day'";
                      $unseen_reports_result = mysqli_query($db_handle, $unseen_reports_query);
                      $rows = mysqli_num_rows($unseen_reports_result);
                    ?>
											<a><h6 style="margin-top:8px" class="text-white"><?=$rows." "?> New Project(s)</h6>
										</div>
									</div>
								</div>
							</div>
          ...
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">Showing Today's Projects</h4>
              <div class="row">
                <div class="col-12">
                    ...
                    <table id="order-listing" class="table">
                      ...
                      <tbody>
                        <?php
                          $report_counter = 1;
                          $empty = TRUE;
                          $table_result = $db_handle->query("SELECT * FROM projects WHERE status ='unseen' AND day='$day'");
