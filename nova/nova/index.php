...
<head>
	...
	<body>
		...
		<div class="wrapper">  
					...
					<div class="container">
						<div class="intro-item fl-wrap">
							<div class="caption text-center cl-white"><br><br><br><br>
								<h2>Your AI Research Partner</h2>
			...
			<div class="clearfix"></div>
			<!-- Footer Section End -->
			<a href="https://wa.me/07018894193"><button style="z-index:9; color:#07b107;background:#93aaba70;" class="w3-button w3-teal w3-xlarge w3-right" onclick=""><i class="fa fa-whatsapp" aria-hidden="true"></i></button></a>
